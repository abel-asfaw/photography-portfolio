...
AWS_DOC_BASE = ...
def get_instance_public_methods(instance): # -> dict[Any, Any]:
...
def document_model_driven_signature(section, name, operation_model, include=..., exclude=...): # -> None:
...
def document_custom_signature(section, name, method, include=..., exclude=...): # -> None:
...
def document_custom_method(section, method_name, method): # -> None:
...
def document_model_driven_method(section, method_name, operation_model, event_emitter, method_description=..., example_prefix=..., include_input=..., include_output=..., exclude_input=..., exclude_output=..., document_output=..., include_signature=...): # -> None:
