...
from . import __version__, _imaging as core
...
class _E:
    ...
    def __mul__(self, other): # -> _NotImplementedType | _E:
        ...
    
    __rmul__ = ...
    def __truediv__(self, other): # -> _NotImplementedType | _E:
        ...
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    @property
    def width(self): # -> Literal[0]:
        ...
    
    @property
    def height(self): # -> Literal[0]:
        ...
    
    @property
    def size(self): # -> tuple[Literal[0], Literal[0]] | tuple[Any, Any | int]:
        ...
    ...
    def tobytes(self, encoder_name=..., *args): # -> bytes:
        """
    ...
    def frombytes(self, data, decoder_name=..., *args): # -> None:
        """
    ...
    def convert(self, mode=..., matrix=..., dither=..., palette=..., colors=...):
        """
    ...
    def quantize(self, colors=..., method=..., kmeans=..., palette=..., dither=...): # -> Image:
        """
    ...
    def getcolors(self, maxcolors=...): # -> list[Any] | None:
        """
    ...
    def getdata(self, band=...): # -> DeferredError | None:
        """
    ...
    def getpalette(self, rawmode=...): # -> list[Any] | None:
        """
    ...
    def getprojection(self): # -> tuple[list[Any], list[Any]]:
        """
    ...
    def resize(self, size, resample=..., box=..., reducing_gap=...):
        """
    ...
    def rotate(self, angle, resample=..., expand=..., center=..., translate=..., fillcolor=...): # -> Image:
        """
    ...
    def getchannel(self, channel): # -> Image:
        """
    ...
    def transform(self, size, method, data=..., resample=..., fill=..., fillcolor=...): # -> Image:
        """
...
def registered_extensions(): # -> dict[Any, Any]:
    """
